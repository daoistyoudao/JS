    ...
    var e = {
            53: e => {
                ! function() {
                    ...
                    function n(e, n) {
                        let o, i, a, r, s, c, l, d;
                        for ("string" == typeof e && (e = t(e)), o = 3 & e.length, i = e.length - o, a = n, s = 3432918353, c = 461845907, d = 0; d < i;) l = 255 & e[d] | (255 & e[++d]) << 8 | (255 & e[++d]) << 16 | (255 & e[++d]) << 24, ++d, l = (65535 & l) * s + (((l >>> 16) * s & 65535) << 16) & 4294967295, l = l << 15 | l >>> 17, l = (65535 & l) * c + (((l >>> 16) * c & 65535) << 16) & 4294967295, a ^= l, a = a << 13 | a >>> 19, r = 5 * (65535 & a) + ((5 * (a >>> 16) & 65535) << 16) & 4294967295, a = 27492 + (65535 & r) + ((58964 + (r >>> 16) & 65535) << 16);
                        switch (l = 0, o) {
                            case 3:
                                l ^= (255 & e[d + 2]) << 16;
                            case 2:
                                l ^= (255 & e[d + 1]) << 8;
                            case 1:
                                l ^= 255 & e[d], l = (65535 & l) * s + (((l >>> 16) * s & 65535) << 16) & 4294967295, l = l << 15 | l >>> 17, l = (65535 & l) * c + (((l >>> 16) * c & 65535) << 16) & 4294967295, a ^= l
                        }
                    ...
                    o.v2 = function(e, n) {
                        ...
                        let o, i = e.length,
                            a = n ^ i,
                            r = 0;
                        for (; i >= 4;) o = 255 & e[r] | (255 & e[++r]) << 8 | (255 & e[++r]) << 16 | (255 & e[++r]) << 24, o = 1540483477 * (65535 & o) + ((1540483477 * (o >>> 16) & 65535) << 16), o ^= o >>> 24, o = 1540483477 * (65535 & o) + ((1540483477 * (o >>> 16) & 65535) << 16), a = 1540483477 * (65535 & a) + ((1540483477 * (a >>> 16) & 65535) << 16) ^ o, i -= 4, ++r;
                        switch (i) {
                            case 3:
                                a ^= (255 & e[r + 2]) << 16;
                            case 2:
                                a ^= (255 & e[r + 1]) << 8;
                            case 1:
                                a ^= 255 & e[r], a = 1540483477 * (65535 & a) + ((1540483477 * (a >>> 16) & 65535) << 16)
                        }
            ...
            861: (e, t, n) => {
                ...
                function a(e, t = 5) {
                    return new Promise((n => {
                        ...
                        for (let a = 0; a < t; a++) {
                            ...
                            fetch(s).then((e => {})).catch((e => {
                                let a = i() - r;
                                o.push(parseFloat(a.toFixed(3))), o.length === t && n(o)
                            }))
                        }
                    }))
                }
                async function r(e) {
                    ...
                    var s = [];
                    for (let t in r) s.push(a(r[t], e.invalidURLTestSamples).then((e => {
                        n[t] = e
                    })));
                    return await Promise.all(s), n.perf = o(i() - t), n
                }
            },
            432: (e, t, n) => {
                "use strict";
                ...
                function a(e) {
                    return new Promise((async function(t, n) {
                        let a = i(),
                            s = [];
                        for (const t of e.config.wsPorts) s.push(r(e.config.wsEndpoint, t, e.config.latencyMeasurements, e.config.uuid));
                ...
                function s(e, t) {
                    return new Promise((function(n) {
                        let i = Math.random().toString(36).replace("0.", ""),
                            a = new Image,
                            r = Date.now();
                        a.src = `${t.config.endpoint}/images/small.png?n=` + e + "&r=" + i, a.onload = function(e) {
                            n(o(Date.now() - r))
                ...
                function c(e) {
                    return new Promise((function(t) {
                        setTimeout((function() {
                            let n = [];
                            for (let t = 0; t <= e.config.imagesToLoad; t++) n.push(s(t, e));
            ...
            372: (e, t, n) => {
                ...
                const r = function(e, t) {
                    return new Promise((n => {
                        ...
                        (async () => {
                            var e = [];
                            if (a.length != o)
                                for (var i = 0; i < o; i++) a.push(await r(37857));
                            for (i = 0; i < o; i++)
                                if (e.push(await r(t)), e.length > 3 && e[0] > 1e3 && e[1] > 1e3 && e[2] > 1e3 && e[3] > 1e3) {
                                    for (var s = i; s < o; s++) e.push(e[0]);
                                    break
                                } n({
                                test_timings: e
                            })
                ...
                async function s() {
                    let e = i();
                    var t = {};
                    for (var n of ["80", "443", "8080", "9222", "9050", "8888", "1080", "3128"]) t[n] = await r("localhost", n);
                    return t.timings_closed = a, t.perf = o(i() - e), t
                }
            },
            611: (e, t, n) => {
                "use strict";
                    ...
                    return new Promise((async e => {
                        const t = /\((khtml|unlike|vizio|like gec|internal dummy|org\.eclipse|openssl|ipv6|via translate|safari|cardamon).+|xt\d+\)/gi,
                            ...
                            x = (({
                                ...
                                const {
                                    ...
                                    const {
                                        ...
                                        platform: t,
                                        maxTouchPoints: n
                                    } = navigator, o = /win(dows|16|32|64|95|98|nt)|wow64/gi.test(e) ? "Windows" : /android|linux|cros/gi.test(e) ? "Linux" : /i(os|p(ad|hone|od))/gi.test(e) ? "iOS" : /mac/gi.test(e) ? "Mac" : "Other", i = /win/gi.test(t) ? "Windows" : /android|arm|linux/i.test(t) ? "Linux" : /i(os|p(ad|hone|od))/gi.test(t) ? "iOS" : /mac/i.test(t) ? "Mac" : "Other", a = /w(in|ow)64/gi.test(e) && /win16/gi.test(t) || /win(16|32)/gi.test(e) && !/win(16|32)/gi.test(t);
                                    return {
                                        core: o,
                                        platformLie: o != i || a,
                                ...
                                if (C.compressed = C.trimmed.replace(t, "").trim(), n.test(C.compressed)) {
                                    if (C.platform = C.compressed.match(n)[0], C.identifiers = C.platform.slice(1, -1).replace(/,/g, ";").split(";").map((e => e.trim())), y(C.identifiers, o)) return C.parsed = C.identifiers.map((e => r.test(e) ? r.exec(e)[0].replace("-", " ") : e)).filter((e => !i.test(e))).join(" ").replace(b ? a : "", "").trim().replace(/\s{2,}/, " "), C;
                                    if (y(C.identifiers, s)) return C.parsed = C.identifiers.filter((e => !c.test(e))).join(" ").replace(/\sNT (\d+\.\d+)/, ((e, t) => "10.0" == t ? " 10" : "6.3" == t ? " 8.1" : "6.2" == t ? " 8" : "6.1" == t ? " 7" : "6.0" == t ? " Vista" : "5.2" == t ? " XP Pro" : "5.1" == t ? " XP" : "5.0" == t ? " 2000" : "4.0" == t ? e : " " + t)).replace(l, "(64-bit)").trim().replace(/\s{2,}/, " "), C;
                                    if (y(C.identifiers, d)) return C.parsed = C.identifiers.filter((e => !u.test(e))).join(" ").replace(b ? g : "", "").trim().replace(/\s{2,}/, " "), C;
                                    if (y(C.identifiers, m)) return C.parsed = C.identifiers.filter((e => !p.test(e))).join(" ").trim().replace(/\s{2,}/, " "), C;
                                    if (y(C.identifiers, f)) return C.parsed = C.identifiers.map((e => {
                                        if (h.test(e)) {
                                            const t = h.exec(e)[0],
                                                n = {
                                                    "10_7": "Lion",
                                        ...
                                        return e
                                    })).filter((e => !w.test(e))).join(" ").replace(/\slike mac.+/gi, "").trim().replace(/\s{2,}/, " "), C;
                                    {
                                        const e = C.identifiers.filter((e => v.test(e)));
                                        return e.length ? (C.parsed = e.join(" ").trim().replace(/\s{2,}/, " "), C) : (C.parsed = C.identifiers.join(" "), C)
                                    }
                                }
                            })({
                                userAgent: S,
                            ...
                            k = (() => {
                                ...
                                if (e) return /windows phone/gi.test(e) ? "Windows Phone" : /win(dows|16|32|64|95|98|nt)|wow64/gi.test(e) ? "Windows" : /android/gi.test(e) ? "Android" : /cros/gi.test(e) ? "Chrome OS" : /linux/gi.test(e) ? "Linux" : /ipad/gi.test(e) ? "iPad" : /iphone/gi.test(e) ? "iPhone" : /ipod/gi.test(e) ? "iPod" : /ios/gi.test(e) ? "iOS" : /mac/gi.test(e) ? "Mac" : "Other"
                            })(),
                            L = await new Promise((async e => {
                                try {
                                    if (!("speechSynthesis" in window)) return e();
                                    let t = !1;
                                    const n = () => {
                                    ...
                                    n(), speechSynthesis.onvoiceschanged = n, setTimeout((() => t ? void 0 : e()), 100)
                                } catch (t) {
                                    return e()
                                }
                            })),
                            ...
                            E = (() => {
                                let e, t;
                                "OffscreenCanvas" in window && (e = new OffscreenCanvas(256, 256), t = new OffscreenCanvas(256, 256));
            ...
            65: (e, t, n) => {
                ...
                function s(e) {
                    return new Promise((t => {
                        ...
                        r.setAttribute("src", e.config.canLoadJsUrl), document.head.appendChild(r), r.onload = function() {
                            let e = document.getElementById("q7a3bil64v7ba2x");
                            a.res = e ? 1 : 0, a.perf = i(o() - n), e && e.parentNode.removeChild(e), t(a)
                        }, r.onerror = function() {
                            a.perf = i(o() - n), t(a)
                        }
                    }))
            ...
            119: (e, t, n) => {
                ...
                function i() {
                    return new Promise((e => {
                        ...
                        })(), f = new Date, w = new Date("07/01/1970"), h = (() => {
                            const [e, t, n] = JSON.stringify(new Date).slice(1, 11).split("-"), o = `${t}/${n}/${e}`, i = `${e}-${t}-${n}`;
                            return {
                                computed: ~~(+(+new Date(o) - +new Date(i)) / 6e4),
                                key: ~~new Date(o).getTimezoneOffset()
                            }
                        })(), v = "" + f.getHours(), y = `${v>12?v-12:v}:${""+t(f.getMinutes())}:${""+t(f.getSeconds())} ${v<12?"AM":"PM"}`;
                        f.setHours(r), f.setMinutes(r), f.setSeconds(r), e({
                            valid: {
                                ...
                                offset: (() => {
                                    try {
                                        return new Date.prototype.getTimezoneOffset, !1
                                    } catch (e) {
                                        const {
                                            name: t,
                                            message: n
            ...
            829: (e, t, n) => {
                ...
                function a(e) {
                    return new Promise((function(t) {
                        ...
                        function c(s) {
                            if (a.finishEvent = s, a.elapsed = i(o() - n, 2), e.config.collectWebRTCMeta) {
                                try {
                            ...
                            e.config.collectWebRTCStats && r.getStats ? r.getStats().then((e => {
                                a.stats = [];
                                for (let t of e) a.stats.push(t)
                            })).finally((() => {
                                a.elapsed2 = i(o() - n, 2), t(a)
                            })) : t(a)
                        }
                        r.createDataChannel(""), r.createOffer((function(e) {
                            r.setLocalDescription(e, s, s)
                        }), s), r.onicecandidate = function(e) {
                ...
                const r = e => new Promise((t => {
                    ...
                    if (setTimeout((function() {
                            a.finishEvent = `timeout: ${e.config.webRTCTimeout}`, a.elapsed = i(o() - n, 2), t(a)
                        }), e.config.webRTCTimeout), navigator.getUserMedia) {
                        ...
                        }, s.createDataChannel(""), s.createOffer((e => {
                        ...
                        const l = async () => {
                            ...
                            })), c = [...new Set(c)], a.ips = c, a.finishEvent = "complete", a.elapsed = i(o() - n, 2), t(a)) : setTimeout(l, 250)
                        };
                        l()
                    } else a.finishEvent = "notSupported", a.elapsed = i(o() - n, 2), t(a)
                }))
            },
            868: (e, t, n) => {
                "use strict";
                ...
                const {
                    ...
                    timezoneTest: a,
                    getTimezoneDetails: r
                } = n(119), {
                    invalidURLTest: s
                } = n(861), {
                    getLatencyWebSocket: c,
                    measureImageLatency: l
                } = n(432), {
                    scanCommonPorts: d
                } = n(372), {
                    dnsResolving: u,
                    canLoadScriptFromUncommonPort: g
                } = n(65), {
                    now: m,
                    round2: p
                } = n(162), {
                ...
                const y = async () => new Promise((e => {
                    if (!navigator.userAgentData) return e("not supported");
                    ...
                    try {
                        if (!("speechSynthesis" in window)) return t("not supported");
                ...
                function T(e, t) {
                    if (navigator && navigator.sendBeacon) return navigator.sendBeacon(e.config.endpoint + "/s", JSON.stringify(t));
                    t.xml_http_req = !0;
                    var n = new XMLHttpRequest;
                    return n.open("POST", e.config.endpoint + "/s", !1), n.setRequestHeader("Content-Type", "text/plain;charset=UTF-8"), n.send(JSON.stringify(t)), !0
                }
                ...
                function D(e) {
                    e.config.dataSent || (e.clientData.fp = function() {
                        ...
                        return e
                    }(), e.clientData.elapsed = m(), T(e, e.clientData))
                }

                function C(e) {
                    try {
                        if (!e.config.runTests) return;
                        ...
                        if (o.then((t => {
                            ...
                            })), t.push(o), e.config.collectMoreSignals) {
                            let n = S();
                            n.then((t => {
                                e.clientData.more = t
                            })), t.push(n)
                        }
                        if (!0 === e.testResults.latency.active && c(e), e.config.imagesToLoad) {
                            let n = l(e);
                        ...
                        if (!0 === e.testResults.webrtc.active) {
                            let t = i(e).then((t => {
                                e.clientData.webrtc = t, e.secondCallback.webrtc = t
                            }));
                            n.push(t)
                        }
                        ...
                        if (!0 === e.testResults.net.active) {
                            ...
                            for (let e of [n, o]) t.push(e)
                        }!0 === e.testResults.browser_portscan.active && t.push(d().then((t => {
                            e.clientData.browserPortscan = t
                        }))), e.config.forceSingleCallback && (t = t.concat(n)), Promise.all(t).then((t => {
                            if (D(e), e.config.dataSent = !0, "visual" === e.config.mode) {
                            ...
                            console.error(t), e.clientData.error = t.toString(), D(e)
                        })), e.config.forceSingleCallback || Promise.all(n).then((t => {
                            e?.clientData?.webrtc || (e.secondCallback.elapsed = m(), T(e, e.secondCallback))
                        }))
                    } catch (t) {
                        e.clientData.error = t.toString(), e.clientData.errorStack = t.stack, D(e), e.config.dataSent = !0
                    }
                }
            }
        },
